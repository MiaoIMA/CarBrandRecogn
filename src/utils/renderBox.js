...
// ... (原来的代码)
	...
	// 定义所有类别和对应的颜色
	const allClasses = [
	  { name: "BMW", color: "#344593" },
	  { name: "Honda", color: "#00C2FF" },
	  { name: "Hyundai", color: "#FF701F" },
	  { name: "Mazda", color: "#FFB21D" },
	  { name: "MercedesBenz", color: "#CFD231" },
	  { name: "Perodua", color: "#48F90A" },
	  { name: "Proton", color: "#92CC17" },
	  { name: "Toyota", color: "#3DDB86" },
	  { name: "Volkswagen", color: "#1A9334" }
	];
